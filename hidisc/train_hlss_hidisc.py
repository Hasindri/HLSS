...
from models import MLP, resnet_backbone, ContrastiveLearningNetwork, HLSSContrastiveLearningNetwork, HLSSHidiscNetwork, CLIPTextClassifier,CLIPVisual
...
class HiDiscSystem(pl.LightningModule):
    ...
    def __init__(self, cf: Dict[str, Any], num_it_per_ep: int,freeze_mlp: bool):
        ...
        mlp1 = partial(CLIPTextClassifier,
                      n_in=1024,
    ...
    def training_step(self, batch, _):
        ...
        # print(f'pred_gather1 {pred_gather1.shape}')
        # print(f'pred_gather2 {pred_gather2.shape}')
...
def main():
    ...
    trainer.fit(exp,
                ...
                val_dataloaders=valid_loader, ckpt_path = "/l/users/hasindri.watawana/hidisc/datasets/opensrh/exps/Exp010/b/e8b3df23-Nov06-14-45-32-patient_disc_dev_/models/ckpt-epoch11599.ckpt")
