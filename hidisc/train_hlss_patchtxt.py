...
from models import MLP, HLSSHidiscNetwork,resnet_backbone, ContrastiveLearningNetwork, HLSSContrastiveLearningNetwork, CLIPTextClassifier,CLIPVisual
...
class HiDiscSystem(pl.LightningModule):
    ...
    def __init__(self, cf: Dict[str, Any], num_it_per_ep: int,freeze_mlp: bool):
        ...
        # checkpoint_path = "/data1/dri/hidisc/hidisc/exps/Exp010/a/c0e640f2-Dec05-10-05-01-patient_disc_dev_/models/ckpt-epoch39999.ckpt"
        ...
        # mlp2.load_state_dict(state_dict_mlp2)
        # self.mlp2 = mlp2
        # self.mlp1 = mlp1
...
def main():
    ...
    trainer.fit(exp,
                ...
                val_dataloaders=valid_loader, ckpt_path = "/data1/dri/hidisc/hidisc/exps/Exp014/b/f1eac020-Jan27-10-42-46-patient_disc_dev_/models/ckpt-epoch1999.ckpt")
